...
import { Ticket } from '@/presentation/features/profile/support/ticket-chat'
import {
    Accordion,
    AccordionContent,
    AccordionItem,
...
export function ProfileContent() {
    ...
    const tabs: (TabItem<TabType> & { component: React.ReactNode })[] = [
        ...
        { id: 'security', label: 'الأمان', icon: Shield, component: <SecuritySection isOAuthUser={isOAuthUser} /> },
        ...
        { id: 'danger', label: 'منطقة الخطر', icon: AlertTriangle, component: <DangerZone isOAuthUser={isOAuthUser} /> },
    ]
