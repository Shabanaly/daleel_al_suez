...
interface CreateEventFormProps {
    places: Place[]
    initialData?: any // SuezEvent from DB
}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        type="datetime-local"
                        required
                        defaultValue={initialData?.start_date ? new Date(new Date(initialData.start_date).getTime() - new Date().getTimezoneOffset() * 60000).toISOString().slice(0, 16) : ''}
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        type="datetime-local"
                        required
                        defaultValue={initialData?.end_date ? new Date(new Date(initialData.end_date).getTime() - new Date().getTimezoneOffset() * 60000).toISOString().slice(0, 16) : ''}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-slate-200 outline-none"
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <select
                        name="placeId"
                        defaultValue={initialData?.place_id || ''}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-slate-200 outline-none"
                    >
