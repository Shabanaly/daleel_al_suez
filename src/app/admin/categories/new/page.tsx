...
export default async function NewCategoryPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 mb-6 shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl sm:text-2xl font-bold text-white mb-1">إضافة تصنيف جديد</h1>
                            <p className="text-sm text-slate-400">أضف تصنيف جديد للأماكن في الدليل</p>
                        </div>
                    </div>
            ...
            <CategoryForm currentUserRole={profile.role} />
        </div>
    )
}
